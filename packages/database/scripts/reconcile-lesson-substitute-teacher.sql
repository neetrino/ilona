-- Idempotent: run against Postgres if GET /lessons/:id fails with
-- "The column lessons.substituteTeacherId does not exist".
-- Prefer: from repo root, `pnpm db:migrate` (applies Prisma migrations).
