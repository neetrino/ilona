...
export const SEGMENTED_TOGGLE_GRID_TRACK_CLASS =
  'relative grid h-11 min-h-11 items-center rounded-[15px] border-2 border-[rgba(14,14,16,0.12)] bg-white p-1 shadow-sm';
...
export const SEGMENTED_TOGGLE_BUTTON_CLASS =
  'relative z-10 flex min-w-0 flex-1 items-center justify-center rounded-[11px] px-4 py-0 text-sm font-semibold transition-colors focus:outline-none focus-visible:outline-none focus-visible:ring-0 h-9';
