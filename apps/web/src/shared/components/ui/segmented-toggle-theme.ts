...
export const SEGMENTED_TOGGLE_INDICATOR_CLASS =
  'pointer-events-none absolute bottom-1 left-1 top-1 z-0 rounded-[11px] bg-[#1010a3] shadow-sm transition-[left,width,transform] duration-300 [transition-timing-function:cubic-bezier(0.22,1,0.36,1)]';
