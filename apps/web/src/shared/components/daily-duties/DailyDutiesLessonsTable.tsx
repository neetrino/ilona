...
interface DailyDutiesLessonsTableProps {
  lessons: DailyDutiesLessonRow[];
...
export function DailyDutiesLessonsTable({
  lessons,
  onView,
  onEdit,
  onDelete,
  ...
  const getObligationsCount = (lesson: DailyDutiesLessonRow) => {
    let count = 0;
