  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-5 flex-1 min-h-0 flex flex-col gap-5">
          ...
          {!readOnly && (
            <button
              type="button"
              onClick={addTopic}
              className="w-full h-11 shrink-0 border-2 border-dashed border-slate-300 rounded-lg text-slate-600 hover:bg-slate-50 active:scale-100"
            >
              + Add another topic
            </button>
          )}
        ...
        <footer className="flex justify-end gap-2 p-4 border-t border-slate-200 bg-white">
          <button
            type="button"
            onClick={onClose}
