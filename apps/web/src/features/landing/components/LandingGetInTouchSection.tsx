    ...
    <section id="contact" className="scroll-mt-28 bg-white">
      <div className="flex flex-col items-center gap-6 px-5 pb-10 pt-10 tablet:hidden">
        <LandingSectionHeader
          title={tr('Get in Touch', 'Կապ մեզ հետ')}
          subtitle={tr("We're here to help!", 'Մենք այստեղ ենք՝ օգնելու համար։')}
          titleClassName="text-[28px] font-extrabold leading-[42px] tracking-[0.35px] text-[#1b3ba4]"
          subtitleClassName="text-[18px] leading-[27px] tracking-[0.07px] text-[rgba(27,59,163,0.4)]"
        />
      ...
      >
        <div className="mx-auto w-full max-w-[896px] px-6 text-center">
          <LandingSectionHeader
            title={tr('Get in Touch', 'Կապ մեզ հետ')}
            subtitle={tr("We're here to help!", 'Մենք այստեղ ենք՝ օգնելու համար։')}
            titleClassName="text-[48px] font-extrabold leading-[48px] tracking-[0.3516px] text-[#1b3ba4]"
            subtitleClassName="mt-6 text-[24px] leading-[32px] tracking-[0.0703px] text-[rgba(27,59,163,0.4)]"
          />
