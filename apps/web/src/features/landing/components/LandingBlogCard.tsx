  ...
  return (
    <LandingStaggerArticle
      className={cn(
        ...
        isMobile ? 'w-full' : 'h-[419.992px] rounded-[32px]',
      )}
    >
      <div
        className={cn(
      ...
      <div className={cn(isMobile ? 'flex flex-col px-5 pb-5 pt-5' : 'px-8 pb-8 pt-8')}>
        <div
          className={cn(
        ...
        <Link
          href={href}
          className={cn(
            'inline-flex items-center gap-2 font-bold text-[#155dfc] transition-opacity hover:opacity-80',
            isMobile
              ? 'mt-3 text-[13px] leading-[19.5px] tracking-[-0.31px]'
              : 'mt-4 text-[16px] leading-[24px] tracking-[-0.3125px]',
          )}
        >
