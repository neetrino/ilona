...
export const whyChooseDesktopBodyBase =
  'mt-4 text-[16px] leading-[24px] tracking-[-0.3125px] text-[#4a5565]';
export const whyChooseDesktopBodyHy =
...
export const whyChooseDesktopTeachersIconWrapBase =
...
export const followMobileCardSubtitleBase =
  'truncate whitespace-nowrap text-[12px] leading-[18px] tracking-[-0.31px] text-white/90';
export const followMobileCardSubtitleHy =
