...
import type { PortalCalendarViewMode } from './portal-calendar.types';

interface PortalCalendarControlsProps {
  viewMode: PortalCalendarViewMode;
  periodHeader: string;
