...
import {
  formatCalendarLessonTime,
  getWeekLessonCardClass,
  isCalendarToday,
} from './portal-calendar-display.util';

interface PortalCalendarWeekViewProps {
  weekDates: Date[];
...
export function PortalCalendarWeekView({
  weekDates,
  lessonsByDate,
  isLoading,
  isTeacherMode,
  hasActiveFilters,
}: PortalCalendarWeekViewProps) {
                    ...
                    {dayLessons.map((lesson) => (
                      ...
                      >
                        <p className="truncate font-medium text-[#3b3b40]">
                          {formatCalendarLessonTime(lesson.scheduledAt)}
                        </p>
