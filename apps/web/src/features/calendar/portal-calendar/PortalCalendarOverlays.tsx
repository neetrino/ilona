...
import type { PortalLessonDetailTab } from './portal-calendar.types';
...
interface PortalCalendarOverlaysProps {
  ...
  lessonDetailSheetTab: PortalLessonDetailTab;
...
export function PortalCalendarOverlays({
  isTeacherMode,
  isAddLessonOpen,
