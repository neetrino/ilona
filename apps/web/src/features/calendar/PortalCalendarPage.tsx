...
import { SubstituteLessonModal } from '@/app/[locale]/(admin)/admin/calendar/components/SubstituteLessonModal';
import { AdminLessonDetailSheet } from '@/app/[locale]/(admin)/admin/calendar/components/AdminLessonDetailSheet';
...
export type PortalCalendarMode = 'admin' | 'teacher';
...
export function PortalCalendarPage({ mode }: PortalCalendarPageProps) {
  ...
  return (
    <DashboardLayout 
      title={isTeacherMode ? t('teacherDailyDutiesTitle') : t('adminTitle')} 
      subtitle={isTeacherMode ? t('teacherDailyDutiesSubtitle') : t('adminSubtitle')}
    >
      <div className={portalPageStackClass}>
        ...
        <div className="bg-white p-4 rounded-xl border border-[rgba(14,14,16,0.07)]">
          <CalendarFilters
            ...
            hideTeacherFilter={isTeacherMode}
          />
        </div>
                  ...
                  >
                    {isLoading ? (
                      ...
                      <p className="text-xs text-[#8b8b90] text-center py-4">
                        {searchQuery || (!isTeacherMode && selectedTeacherId)
                          ? isTeacherMode
          ...
          <>
            {isListLoading ? (
              ...
              <LessonListTable
                ...
                onDelete={isTeacherMode ? undefined : handleSingleDeleteClick}
                onAssignSubstitute={isTeacherMode ? undefined : handleAssignSubstitute}
              />
            )}
          </>
        )}
