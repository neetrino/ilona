...
import { useAddLessonForm } from './add-lesson-form/useAddLessonForm';
import { AddLessonFormFields } from './add-lesson-form/AddLessonFormFields';
import type { AddLessonFormProps } from './add-lesson-form/add-lesson-form.types';

export type { AddLessonFormProps } from './add-lesson-form/add-lesson-form.types';

export function AddLessonForm(props: AddLessonFormProps) {
  const form = useAddLessonForm(props);
