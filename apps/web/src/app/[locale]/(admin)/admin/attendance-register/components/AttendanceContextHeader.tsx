  ...
  if (viewMode === 'day') {
    return (
      <div className="space-y-5">
        ...
        <div className="h-px w-full bg-[#e8eaf3]" />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2 rounded-2xl border border-[#d9f0df] bg-[#e8f8ed] px-3 py-2 text-[#1f2a37]">
            ...
            <span className="text-[16px] font-semibold leading-none md:text-[18px]">{t('sessionsCount', { count: lessonsCount })}</span>
          </div>
          <div className="flex items-center gap-2 rounded-2xl border border-[#eceef5] bg-[#f6f7fb] px-3 py-2 text-[#1f2a37]">
            ...
            <span className="text-[16px] font-semibold leading-none md:text-[18px]">{t('studentsCount', { count: studentsCount })}</span>
          </div>
        </div>
      </div>
    );
