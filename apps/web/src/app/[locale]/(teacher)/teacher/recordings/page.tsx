...
import { isOnboardingItem, type Student, type TeacherAssignedItem } from '@/features/students/types';
...
const GROUP_STORAGE_KEY = 'teacher-recordings:selected-group';
const STUDENT_STORAGE_KEY = 'teacher-recordings:selected-student';
...
export default function TeacherRecordingsPage() {
  ...
  const { data: recordings = [], isLoading } = useQuery({
    queryKey: [...chatKeys.all, 'teacher', 'student-recordings', apiFilters],
    queryFn: () => fetchTeacherStudentRecordings(apiFilters),
