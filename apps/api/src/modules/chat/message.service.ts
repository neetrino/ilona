...
export class MessageService {
  ...
  /**
   * Get student voice messages sent to teachers for a specific teacher.
   * Returns only recordings from students assigned to this teacher (by group or direct teacher relation).
   */
